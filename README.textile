...
5. If the project artifact file does not exist, it performs a Build (see the Build section below)
...
* if @:build-via@ is specified in the configuration, its value is used
